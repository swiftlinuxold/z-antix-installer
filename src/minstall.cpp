// This is the installation script for Swift Linux.  
// This is based on the antiX Linux script but has a few changes.
// 1.  "title antiX" has been replaced with "title Swift Linux"
...
void MInstall::pageDisplayed(int next) {
  ...
  switch (next) {
    ...
    case 3:
      setCursor(QCursor(Qt::WaitCursor));
      tipsEdit->setText(tr("<p><b>Special Thanks</b><br/>My thanks to everyone who has chosen to support Swift Linux with their time, money, suggestions, work, praise, ideas, promotion, and/or encouragement.</p>"
      "<p>Without you there would be no Swift Linux.</p>"
      "<p>anticapitalista</p>"));
...
void MInstall::copyTime() {
  ...
  switch (i) {
    ...
    case 30:
      if (!getCmdValue("cat /etc/default/antiX","SERVER","="," ").contains("yes", Qt::CaseInsensitive)) {
      tipsEdit->setText(tr("<p><b>Support Swift Linux</b><br/>"
    ...
    case 60:
      tipsEdit->setText(tr("<p><b>Keep Your Copy of Swift Linux Up-to-date</b><br/>"
